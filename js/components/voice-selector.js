...
export class VoiceSelector {
    constructor(langSelectEl, voiceSelectEl, provider, onChangeCallback) {
        ...
        // Accepts anything with a getVoices() method — normally a
        // BrowserProvider instance, so language filtering stays scoped to
    ...
    async loadVoices() {
        ...
        // Sort languages by their human-readable label, not the raw code,
        // so "English (United States)" sorts with the other English
        // entries instead of wherever "en-US" happens to fall alphabetically.
